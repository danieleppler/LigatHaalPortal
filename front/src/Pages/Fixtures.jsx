...
import { DailyReqFallback, MinutleyReqFallback } from '../FallBacks/RequestsFallback'
...
const Fixtures = ({ team_id }) => {
    ...
    const fixtures_list = <ul className='pos-relative display-flex justify-center flex-cols row-gap-1'>
        {
            fixtures?.map((x) => {
